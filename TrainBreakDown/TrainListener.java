...
public class TrainListener {
    ...
    public static void main(String[] args) {
        ...
        String serverURL = sc.next(); //Get the new serverURL and update it

        if (serverURL.equals("1")) {
            serverURL = "localhost";
        }

        TrainMsgConsumer weatherTopic = new TrainMsgConsumer(serverURL, "t.weather", TrainMsgConsumer.TOPIC);
